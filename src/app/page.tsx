...
function Divider() {
  return (
    <div className="mx-auto flex w-full max-w-56 items-center gap-3" aria-hidden="true">
      <span className="h-px flex-1 bg-[rgba(217,181,109,0.58)]" />
      <span className="h-1.5 w-1.5 rotate-45 border border-[rgba(217,181,109,0.75)]" />
      <span className="h-px flex-1 bg-[rgba(217,181,109,0.58)]" />
    </div>
  );
}
...
function BranchOrnament() {
  return (
    <div className="mx-auto flex items-center justify-center gap-2 text-[rgba(217,181,109,0.78)]" aria-hidden="true">
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[var(--background)] px-4 py-6 text-[var(--color-ink)] sm:px-6 sm:py-10">
      <article className="mx-auto w-full max-w-3xl rounded-2xl border border-[rgba(217,181,109,0.34)] bg-[var(--color-white-warm)] px-5 py-9 shadow-[0_18px_48px_rgba(74,46,42,0.06)] sm:px-10 sm:py-12">
        <header className="text-center">
          <p className="text-sm font-semibold uppercase text-[rgba(74,46,42,0.58)]">
            Nos casamos
          </p>
          ...
          <h1 className="mx-auto max-w-2xl font-serif-display text-5xl leading-none text-[var(--color-ink)] sm:text-6xl md:text-7xl">
            Sofía & Mateo
          </h1>

          <p className="mt-7 text-sm font-semibold uppercase text-[rgba(74,46,42,0.68)] sm:text-base">
            15 · 11 · 2026
          </p>

          <p className="mx-auto mt-8 max-w-xl text-balance text-base leading-8 text-[rgba(74,46,42,0.76)] sm:text-lg">
            Con mucha alegría queremos invitarte a compartir uno de los días
            más importantes de nuestra vida.
          </p>
        </header>

        <section className="mt-10 border-y border-[rgba(217,181,109,0.32)] py-8 sm:mt-12 sm:py-10">
